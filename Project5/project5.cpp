...
//Programmer: Yi Zhou
//Date: 04/15/2022
//Purpose: Event driven simulation.
//I only added header for files I've modified. I did not change anything
//in this file.

//I took this course last semester.
//Since it is the same project as before, I mostly
// used my own code from last semester.
//I've taken some time to make sure that I fully understand the project
// and the requirements.
//In this submission number one, I will submit the my own code from last
// semester.
//I'll submit new versions if I tune some of it.
int main(
     int argc,
     char *argv[]
     )
